...
main_dash = html.Div([
        dbc.Row(
            [
                dbc.Col(html.H4(children='Main Dashboard:'), width=1.5),
                dbc.Col(dcc.Dropdown(id='main-drop', multi=False,
...
feature_dash = html.Div([
        dbc.Row(
            ...
            dbc.Col(
                [
                    dbc.Row(html.H4(children='Features graph:'), style={'padding': '20px'}),
                    dcc.Graph(id='features-graph', figure={'layout': {'height': 200}})
                ],
                width=10),
            dbc.Col(
                [
                    dbc.Row(html.H4(children='Model features:'), style={'padding': '20px'}),
...
factor_dash = html.Div([
        dbc.Row(html.H4(children='Factor analysis:'), style={'padding': '20px'}),
        dbc.Col(
